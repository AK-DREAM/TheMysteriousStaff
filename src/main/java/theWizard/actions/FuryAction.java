...
public class FuryAction extends AbstractGameAction {
    private int mxcard;
    public FuryAction(int mx) {
        this.duration = 0.0F;
        ...
        if (AbstractDungeon.player.hand.size() < mxcard) {
            while (var1.hasNext()) {
                ...
                if (c.type != CardType.ATTACK) {
                    AbstractDungeon.actionManager.addToTop(new DrawCardAction(1, new FuryAction(this.mxcard)));
                    break;
                }
            }
        }
