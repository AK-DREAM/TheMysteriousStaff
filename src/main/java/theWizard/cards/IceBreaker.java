...
public class IceBreaker extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(IceBreaker.class.getSimpleName());
    public static final String IMG = makeCardPath("IceBreaker.png");
